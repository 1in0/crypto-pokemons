...
contract Base is Ownable {
	...
	constructor() public {
		...
		basePokemons.push(BasePokemon("VenusaurMega Venusaur", 3, "Grass", "Poison", 275, false, BaseStats(80, 100, 123, 122, 120, 80)));
		...
		basePokemons.push(BasePokemon("CharizardMega Charizard X", 6, "Fire", "Dragon", 266, false, BaseStats(78, 130, 111, 130, 85, 100)));
		basePokemons.push(BasePokemon("CharizardMega Charizard Y", 6, "Fire", "Flying", 266, false, BaseStats(78, 104, 78, 159, 115, 100)));
		...
		basePokemons.push(BasePokemon("BlastoiseMega Blastoise", 9, "Water", "nan", 270, false, BaseStats(79, 103, 120, 135, 115, 78)));
		...
		basePokemons.push(BasePokemon("BeedrillMega Beedrill", 15, "Bug", "Poison", 405, false, BaseStats(65, 150, 40, 15, 80, 145)));
		...
		basePokemons.push(BasePokemon("PidgeotMega Pidgeot", 18, "Normal", "Flying", 321, false, BaseStats(83, 80, 80, 135, 80, 121)));
		...
		basePokemons.push(BasePokemon("AlakazamMega Alakazam", 65, "Psychic", "nan", 310, false, BaseStats(55, 50, 65, 175, 95, 150)));
		...
		basePokemons.push(BasePokemon("SlowbroMega Slowbro", 80, "Water", "Psychic", 310, false, BaseStats(95, 75, 180, 130, 80, 30)));
		...
		basePokemons.push(BasePokemon("GengarMega Gengar", 94, "Ghost", "Poison", 300, false, BaseStats(60, 65, 80, 170, 95, 130)));
		...
		basePokemons.push(BasePokemon("KangaskhanMega Kangaskhan", 115, "Normal", "nan", 310, false, BaseStats(105, 125, 100, 60, 100, 100)));
		...
		basePokemons.push(BasePokemon("PinsirMega Pinsir", 127, "Bug", "Flying", 300, false, BaseStats(65, 155, 120, 65, 90, 105)));
		...
		basePokemons.push(BasePokemon("GyaradosMega Gyarados", 130, "Water", "Dark", 260, false, BaseStats(95, 155, 109, 70, 130, 81)));
		...
		basePokemons.push(BasePokemon("AerodactylMega Aerodactyl", 142, "Rock", "Flying", 285, false, BaseStats(80, 135, 85, 70, 95, 150)));
